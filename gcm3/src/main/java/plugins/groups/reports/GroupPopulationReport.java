...
public final class GroupPopulationReport extends PeriodicReport {
	...
	public GroupPopulationReport(ReportPeriod reportPeriod) {
		super(reportPeriod);
	}
	...
	protected void flush(ReportContext reportContext) {
		...
		for (GroupTypeId groupTypeId : personGroupDataView.getGroupTypeIds()) {
			...
			for (GroupId groupId : personGroupDataView.getGroupsForGroupType(groupTypeId)) {
				Integer personCountForGroup = personGroupDataView.getPersonCountForGroup(groupId);
