 ...
 */
@Immutable
public final class GroupInitialData implements DataView {
	...
	private GroupInitialData(Data data) {
		this.data = data;
	}
	...
	public static class Builder {
		 ...
		 *             person was added to a group that was not defined
		 * 
		 ...
		 * 
		 */
		public GroupInitialData build() {
			try {
				validate(data);
				return new GroupInitialData(data);
			} finally {
				data = new Data();
			}
		}
