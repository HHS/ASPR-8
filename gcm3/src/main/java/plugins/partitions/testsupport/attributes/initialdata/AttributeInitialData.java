...
@Immutable
public class AttributeInitialData implements DataView {
	...
	public static class Builder {
		...
		/**
		 * Returns the {@linkplain AttributeInitialData} from the collected data
		 */
		public AttributeInitialData build() {
			try {
				return new AttributeInitialData(data);
			} finally {
				data = new Data();
			}
		}
	...
	private AttributeInitialData(Data data) {
		this.data = data;
	}
