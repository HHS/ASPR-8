...
public enum RegionError implements ContractError {
	...
	NULL_REGION_COMPONENT_INITIAL_BEHAVIOR_SUPPLIER("Null region component initial behavior supplier"),
	...
	DUPLICATE_REGION_INITIAL_BEHAVIOR_ASSIGNMENT("Duplicate region component class assignment"),
