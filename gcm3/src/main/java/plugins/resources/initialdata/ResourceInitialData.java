 ...
 */
@Immutable
public final class ResourceInitialData implements DataView {
	...
	private ResourceInitialData(Data data) {
		this.data = data;
	}
	...
	public static class Builder {
		 ...
		 * 
		 */
		public ResourceInitialData build() {
			try {
				...
				validateData(data);
				return new ResourceInitialData(data);
			} finally {
				data = new Data();
			}
		}
