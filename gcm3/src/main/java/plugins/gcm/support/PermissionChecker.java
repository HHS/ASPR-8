...
public final class PermissionChecker {
	...
	public static PermissionChecker newChecker(DataManagerContext dataManagerContext, ComponentDataView componentDataView) {
		return new PermissionChecker(dataManagerContext, componentDataView);
	}

	private PermissionChecker(DataManagerContext dataManagerContext, ComponentDataView componentDataView) {
	...
	public void check() {
		if (!dataManagerContext.currentAgentIsEventSource()) {
			...
			if (permitResolverGeneratedEvents) {
				...
				dataManagerContext.throwContractException(GcmError.COMPONENT_LACKS_PERMISSION);
			}
		} else {
