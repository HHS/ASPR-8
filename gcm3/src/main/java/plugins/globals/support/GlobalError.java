...
public enum GlobalError implements ContractError {
	...
	NULL_GLOBAL_INITIAL_DATA("Null global initial data"),
	...
	DUPLICATE_GLOBAL_COMPONENT_INITIAL_BEHAVIOR_ASSIGNMENT("Duplicate global component agent initial behavior assignment"),
	
	DUPLICATE_GLOBAL_COMPONENT_ID("Duplicate global component id"),
