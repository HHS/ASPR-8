 ...
 * views to actors. It is supplied by the engine each time it interacts with an
 * actor. Actors are defined by this context. If this context is passed to a
...
public interface ActorContext extends SimulationContext {
	 ...
	 * T that are generated by event resolution (not events generated by actors)
	 * are matched to the event label. If a match is found, then the event will
	 * be consumed by the supplied ActorEventConsumer.
	 * 
	 * 
	 * @throws ContractException
