...
public interface ResolverContext extends Context {
	...
	/**
	 * Returns true if and only if the current agent generated the current event
	 */
	...
	/**
	 * Returns the next available agent id for use in agent construction
	 */
	...
	/**
	 * Returns the ResolverId of the current agent
	 */
	...
	/**
	 * Adds a report to the simulation. The report is added immediately, but the
	 * consumer of ReoprtContext is invoked after event resolution is finished
	 * and before time progresses.
	 * 
	 * @throws ContractException
	 *             <li>{@link NucleusError#NULL_REPORT_ID} if the report id is
	 *             null
	 *             <li>{@link NucleusError#NULL_REPORT_CONTEXT_CONSUMER} if the
	 *             report context consumer is null
	 *             <li>{@link NucleusError#REPORT_ID_IN_USE} if the report id is
	 *             in use by another report
	 */
	 ...
	 * of validation of the event. No changes to data views should take place
	 * during this process and all exceptions should be recoverable.
	 * 
	 * @throws ContractException
	...
	/**
	 * Returns a context that restrict access to non-mutable data nucleus
	 */
	...
	/**
	 * Adds a data view to the set of data view available to all contexts.
	 * 
	 * @throws ContractException
	 * <li>{@linkplain NucleusError#NULL_DATA_VIEW} if the data view is null</li>
	 */
