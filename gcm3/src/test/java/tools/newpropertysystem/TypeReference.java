 ...
 * information by sub-classing; it must be converted to {@link ResolvedType}
 * implementation (implemented by <code>JavaType</code> from "databind" bundle)
 * to be used. Class is based on ideas from
