...
@UnitTest(target = CompartmentPlugin.class)
public class AT_CompartmentPlugin {
	...
	public void testInit() {
		 ...
		 */
		new CompartmentPlugin(CompartmentInitialData.builder().build()).init(mockPluginContext);
