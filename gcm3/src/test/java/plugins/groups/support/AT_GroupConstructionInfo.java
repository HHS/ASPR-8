...
public final class AT_GroupConstructionInfo {
	...
	public void testGetPropertyValues() {
		RandomGenerator randomGenerator = SeedProvider.getRandomGenerator(6591155321511911942L);
		for (TestGroupTypeId testGroupTypeId : TestGroupTypeId.values()) {
	...
	public void testSetGroupPropertyValue() {
		...
		RandomGenerator randomGenerator = SeedProvider.getRandomGenerator(5862480779334008230L);
