	...
	public void testGetEventLabelByGroupTypeAndPerson() {
		...
		GroupsActionSupport.testConsumer(10, 3, 5, 2396297410749360025L, (c) -> {
			...
			for (TestGroupTypeId testGroupTypeId : TestGroupTypeId.values()) {
				...
				// show that the event label has the same id as its
				// associated labeler
				EventLabeler<GroupMembershipRemovalObservationEvent> eventLabeler = GroupMembershipRemovalObservationEvent.getEventLabelerForGroupTypeAndPerson(personGroupDataView);
				assertEquals(eventLabeler.getId(), eventLabel.getLabelerId());
	...
	public void testGetEventLabelByGroupType() {
		...
		GroupsActionSupport.testConsumer(0, 3, 5, 4360946626249599442L, (c) -> {
			...
			for (TestGroupTypeId testGroupTypeId : TestGroupTypeId.values()) {
				...
				// show that the event label has the same id as its
				// associated labeler
				EventLabeler<GroupMembershipRemovalObservationEvent> eventLabeler = GroupMembershipRemovalObservationEvent.getEventLabelerForGroupType(personGroupDataView);
				assertEquals(eventLabeler.getId(), eventLabel.getLabelerId());
