...
public class AT_FloatPropertyManager {
	...
	public void testGetPropertyValue() {
		...
		FloatPropertyManager floatPropertyManager = new FloatPropertyManager(mockSimulationContext, propertyDefinition, 0);
	...
	public void testGetPropertyTime() {
		...
		FloatPropertyManager doublePropertyManager2 = new FloatPropertyManager(mockSimulationContext, propertyDefinition, 0);
		for (int i = 0; i < 1000; i++) {
			int id = randomGenerator.nextInt(300);
		...
		FloatPropertyManager fpm = new FloatPropertyManager(mockSimulationContext, propertyDefinition, 0);
	...
	public void testRemoveId() {
		...
		floatPropertyManager = new FloatPropertyManager(mockSimulationContext, propertyDefinition, 0);
		...
		FloatPropertyManager fpm = new FloatPropertyManager(mockSimulationContext, def, 0);
	...
	public void testConstructor() {
		...
		ContractException contractException = assertThrows(ContractException.class, () -> new FloatPropertyManager(mockSimulationContext, null, 0));
		assertEquals(PropertyError.NULL_PROPERTY_DEFINITION, contractException.getErrorType());

		// if the property definition does not have a type of Float.class
		contractException = assertThrows(ContractException.class, () -> new FloatPropertyManager(mockSimulationContext, badPropertyDefinition, 0));
		...
		contractException = assertThrows(ContractException.class, () -> new FloatPropertyManager(mockSimulationContext, badFloatPropertyDefinition, 0));
		...
		contractException = assertThrows(ContractException.class, () -> new FloatPropertyManager(mockSimulationContext, goodPropertyDefinition, -1));
		assertEquals(PropertyError.NEGATIVE_INITIAL_SIZE, contractException.getErrorType());

		FloatPropertyManager doublePropertyManager = new FloatPropertyManager(mockSimulationContext, goodPropertyDefinition, 0);
