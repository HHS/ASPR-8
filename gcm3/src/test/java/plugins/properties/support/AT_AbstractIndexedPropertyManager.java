...
public class AT_AbstractIndexedPropertyManager {
	...
	private static class SimplePropertyManager extends AbstractIndexedPropertyManager {
		...
		public SimplePropertyManager(SimulationContext simulationContext, PropertyDefinition propertyDefinition, int initialSize) {
	...
	public void testConstructor() {
		...
		SimplePropertyManager simplePropertyManager = new SimplePropertyManager(mockSimulationContext, goodPropertyDefinition, 0);
	...
	public void testSetPropertyValue() {
		...
		// precondition tests
		SimplePropertyManager simplePropertyManager = new SimplePropertyManager(mockSimulationContext, propertyDefinition, 0);
	...
	public void testGetPropertyTime() {
		...
		SimplePropertyManager spm = new SimplePropertyManager(mockSimulationContext, propertyDefinition, 0);
	...
	public void testRemoveId() {		
		...
		SimplePropertyManager spm = new SimplePropertyManager(mockSimulationContext, def, 0);
