package plugins.partitions.testsupport.attributes.initialdata;
...
@UnitTest(target = AttributeInitialData.class)
public class AT_AttributeInitialData implements DataView {

	@Test
	@UnitTestMethod(name = "builder", args = {})
	public void testBuilder() {
		assertNotNull(AttributeInitialData.builder());
	}

	@Test
	@UnitTestMethod(target = AttributeInitialData.Builder.class, name = "build", args = {})
	public void testBuild() {
		assertNotNull(AttributeInitialData.builder().build());
	}

	@Test
	@UnitTestMethod(target = AttributeInitialData.Builder.class, name = "defineAttribute", args = { AttributeId.class, AttributeDefinition.class })
	public void testDefineAttribute() {
		AttributeInitialData.Builder builder = AttributeInitialData.builder();
		...
		AttributeInitialData attributeInitialData = builder.build();
		assertEquals(EnumSet.allOf(TestAttributeId.class), attributeInitialData.getAttributeIds());
		for (TestAttributeId testAttributeId : TestAttributeId.values()) {
			assertEquals(testAttributeId.getAttributeDefinition(), attributeInitialData.getAttributeDefinition(testAttributeId));
		}
	...
	public void testGetAttributeDefinition() {
		...
		// if the attribute id is null
		ContractException contractException = assertThrows(ContractException.class, () -> attributeInitialData.getAttributeDefinition(null));
		assertEquals(AttributeError.NULL_ATTRIBUTE_ID, contractException.getErrorType());

		// if the attribute id is unknown</li>
		contractException = assertThrows(ContractException.class, () -> attributeInitialData.getAttributeDefinition(TestAttributeId.getUnknownAttributeId()));
