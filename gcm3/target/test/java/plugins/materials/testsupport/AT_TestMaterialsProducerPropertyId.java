...
public class AT_TestMaterialsProducerPropertyId {
	...
	public void testGetRandomPropertyValue() {
		...
		RandomGenerator randomGenerator = SeedProvider.getRandomGenerator(7973900878959109442L);
	...
	public void testGetRandomMaterialsProducerPropertyId() {
		...
		RandomGenerator randomGenerator = SeedProvider.getRandomGenerator(5963531689679394818L);
	...
	public void testGetRandomMutableMaterialsProducerPropertyId() {
		RandomGenerator randomGenerator = SeedProvider.getRandomGenerator(8476649750185982818L);
		for (int i = 0; i < 10; i++) {
