...
Each is generated by the ExampleDataManager, @lst-events_intro_to_event_generation, when the alpha or beta values are mutated by releasing the events through the DataManagerContext to the simulation:
