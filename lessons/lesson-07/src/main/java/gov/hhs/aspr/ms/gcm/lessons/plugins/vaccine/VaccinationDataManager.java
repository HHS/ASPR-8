...
public final class VaccinationDataManager extends DataManager {
	...
	/* start code_ref=dag_dependent_query|code_cap=By adding plugin dependencies on the people and family plugins, the vaccine data manager can now answer questions about the vaccine status of family members*/
