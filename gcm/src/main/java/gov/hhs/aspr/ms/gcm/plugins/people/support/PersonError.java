...
public enum PersonError implements ContractError {
	// person
	NEGATIVE_PERSON_ID("Negative person id"), NULL_PERSON_DATA_MANAGER("Null person data manager"),
	NULL_AUXILIARY_DATA("Null auxiliary data"), NULL_PERSON_CONSTRUCTION_DATA("Null person construction data"),
	NULL_PERSON_ID("Null person id"), NULL_PERSON_RANGE("Null person range"), UNKNOWN_PERSON_ID("Unknown person id"),
	DUPLICATE_PERSON_ID("Duplicate person addition"), ILLEGAL_PERSON_RANGE("Illegal person range"),
	...
	PERSON_ASSIGNMENT_TIME_IN_FUTURE(
			"The person assignment time from the plugin data is greater than the current time in the simulation"),
