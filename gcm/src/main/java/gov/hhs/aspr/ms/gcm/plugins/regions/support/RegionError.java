...
public enum RegionError implements ContractError {
	DUPLICATE_PERSON_ADDITION("Duplicate person region addition"), DUPLICATE_REGION_ID("Duplicate region id"),
	MISSING_REGION_ASSIGNMENT("Region assignment is missing"), NON_FINITE_TIME("Not a finite time value"),
	NULL_TIME("Not time value"), NULL_AUXILIARY_DATA("Null auxiliary data"),
	NULL_REGION_CONSTRUCTION_DATA("Null region construction data"), NULL_REGION_ID("Null region id"),
	...
	REGION_ARRIVAL_TIMES_MISMATCHED(
			"Person region arrival times are actively tracked, but region assignment and region arrival assignments do not align"),
	...
	MISSING_PERSON_ARRIVAL_DATA(
			"Person regions were recorded and no arrival times were recorded while the tracking policy is true"),
