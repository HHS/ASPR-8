...
public enum TestResourcePropertyId implements ResourcePropertyId {
    ...
    ResourceProperty_1_1_BOOLEAN_MUTABLE(TestResourceId.RESOURCE_1,
            PropertyDefinition.builder().setType(Boolean.class).setDefaultValue(false).build()),
    ResourceProperty_1_2_INTEGER_MUTABLE(TestResourceId.RESOURCE_1,
            PropertyDefinition.builder().setType(Integer.class).setDefaultValue(0).build()),
    ResourceProperty_1_3_DOUBLE_MUTABLE(TestResourceId.RESOURCE_1,
            PropertyDefinition.builder().setType(Double.class).setDefaultValue(0.0).build()),
    ResourceProperty_2_1_BOOLEAN_MUTABLE(TestResourceId.RESOURCE_2,
            PropertyDefinition.builder().setType(Boolean.class).setDefaultValue(true).build()),
    ResourceProperty_2_2_INTEGER_MUTABLE(TestResourceId.RESOURCE_2,
            PropertyDefinition.builder().setType(Integer.class).setDefaultValue(5).build()),
    ResourceProperty_3_1_BOOLEAN_MUTABLE(TestResourceId.RESOURCE_3,
            PropertyDefinition.builder().setType(Boolean.class).setDefaultValue(false).build()),
    ResourceProperty_3_2_STRING_MUTABLE(TestResourceId.RESOURCE_3,
            PropertyDefinition.builder().setType(String.class).setDefaultValue("").build()),
    ResourceProperty_4_1_BOOLEAN_MUTABLE(TestResourceId.RESOURCE_4,
            PropertyDefinition.builder().setType(Boolean.class).setDefaultValue(true).build()),
    ResourceProperty_5_1_INTEGER_IMMUTABLE(TestResourceId.RESOURCE_5,
            PropertyDefinition.builder().setType(Integer.class).setDefaultValue(7).setPropertyValueMutability(false)
                    .build()),
    ResourceProperty_5_2_DOUBLE_IMMUTABLE(TestResourceId.RESOURCE_5, PropertyDefinition.builder().setType(Double.class)
            .setDefaultValue(2.7).setPropertyValueMutability(false).build());
    ...
    public static TestResourcePropertyId getRandomResourcePropertyId(TestResourceId testResourceId,
    ...
    public static List<TestResourcePropertyId> getTestResourcePropertyIds() {
        return Arrays.asList(TestResourcePropertyId.values());
    }

    public static List<TestResourcePropertyId> getShuffledTestResourcePropertyIds(RandomGenerator randomGenerator) {
        List<TestResourcePropertyId> result = getTestResourcePropertyIds();
