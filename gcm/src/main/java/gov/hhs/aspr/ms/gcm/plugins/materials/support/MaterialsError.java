...
public enum MaterialsError implements ContractError {
	...
	BATCH_ALREADY_INVENTORIED("Batch is already in another inventory"), BATCH_ALREADY_STAGED("Batch is already staged"),
	...
	BATCH_SHIFT_WITH_MULTIPLE_OWNERS(
			"Cannot shift material from a batch to another batch not owned by the same materials producer"),
	...
	MATERIAL_TYPE_MISMATCH("Material identifiers do not match"), NEGATIVE_BATCH_ID("Negative batch id"),
	NEGATIVE_MATERIAL_AMOUNT("Material amount is negative"), NEGATIVE_STAGE_ID("Negative stage id"),
	...
	NON_FINITE_MATERIAL_AMOUNT("Material amount is not finite"), NULL_AUXILIARY_DATA("Null auxiliary data"),
	NULL_BATCH_CONSTRUCTION_INFO("Null batch construction info"), NULL_BATCH_ID("Null batch id"),
	NULL_BATCH_STATUS_REPORT_PLUGIN_DATA("Null batch status report plugin data"), NULL_MATERIAL_ID("Null material id"),
	NULL_MATERIALS_PLUGIN_DATA("Null materials initial data"), NULL_MATERIALS_PRODUCER_ID("Null materials producer id"),
	NULL_MATERIALS_PRODUCER_PROPERTY_DEFINITION_INITIALIZATION(
			"Null materials producer property definition initialization"),
	...
	NULL_STAGE_CONVERSION_INFO("Null stage conversion info"), NULL_STAGE_ID("Null stage id"),
	...
	UNKNOWN_BATCH_ID("Unknown batch id"), UNKNOWN_MATERIAL_ID("Unknown material id"),
	UNKNOWN_MATERIALS_PRODUCER_ID("Unknown materials producer id"), UNKNOWN_STAGE_ID("Unknown stage id"),
