...
public interface PopulationPartition {
	 ...
	 * 
	 * Preconditions : Should only be used to add people who have just been
	 * created and thus cannot already be members.
	 * 
	...
	/**
	 * Handles the relevant data change to a person
	 * 
	 * preconditions: the event must not be null
	 */
	 ...
	 * partition.
	 * 
	 * Precondition: label set may not be null
	 */
	 ...
	 * Returns the number of people contained in this
	 * {@link PopulationPartition} that are contained in cells that match the
	 * given {@link LabelSet}, mapped to each cell.
	 */
	 ...
	 * 
	 * Precondition : the label set must be non-null and contain only compatible
	 * dimensions with this population partition.
	 */
