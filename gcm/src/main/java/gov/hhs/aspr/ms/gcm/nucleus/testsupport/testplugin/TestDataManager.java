...
public class TestDataManager extends DataManager {
	...
	/*
	 * Package level access for setting the alias of the data manager. This is done
	 * immediately after construction, before any integration into the experiment or
	 * simulation.
	 */
	...
	/**
	 * Associates its ActorId. Schedules the ActorActionPlans that were stored in
