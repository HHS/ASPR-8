...
//	 * handling after the data manager is finished with its current activation.
//	 * 
//	 * This is used for MUTATION events that are generated by the data managers
//	 * as a proxy for actors and data managers. OBSERVATION events should use
//	 * releaseObservationEvent() instead.
//	 * 
//	 * @throws ContractException
//	 *             <li>{@link NucleusError#NULL_EVENT} if the event is null
//	 */
//	public void releaseMutationEvent(final Event event) {
//		simulation.releaseMutationEvent(event);
//	}
