...
public class AT_AttributesPluginData {
	...
	public void testDefineAttribute() {
		...
		ContractException contractException = assertThrows(ContractException.class,
				() -> builder.defineAttribute(null, TestAttributeId.BOOLEAN_0.getAttributeDefinition()));
		...
		contractException = assertThrows(ContractException.class,
				() -> builder.defineAttribute(TestAttributeId.BOOLEAN_0, null));
		...
		contractException = assertThrows(ContractException.class, () -> builder
