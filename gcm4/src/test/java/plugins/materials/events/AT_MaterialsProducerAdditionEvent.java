...
@UnitTest(target = MaterialsProducerAdditionEvent.class)
public class AT_MaterialsProducerAdditionEvent {
    ...
    public void testBuild() {
        ...
        ContractException contractException = assertThrows(ContractException.class,
                () -> MaterialsProducerAdditionEvent.builder().setMaterialsProducerId(nProducerId).build());
    ...
    public void testAddValue() {
        ...
        ContractException contractException = assertThrows(ContractException.class,
                () -> MaterialsProducerAdditionEvent.builder().addValue(null));
        assertEquals(MaterialsError.NULL_AUXILIARY_DATA, contractException.getErrorType());
    }

    @Test
    @UnitTestMethod(target = MaterialsProducerAdditionEvent.Builder.class, name = "setMaterialsProducerId", args = {
    ...
    public void testSetMaterialsProducerId() {
        ...
        // precondition: null materials producer id
        ContractException contractException = assertThrows(ContractException.class,
                () -> MaterialsProducerAdditionEvent.builder().setMaterialsProducerId(null));
        assertEquals(MaterialsError.NULL_MATERIALS_PRODUCER_ID, contractException.getErrorType());
    }
}
