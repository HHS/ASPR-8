...
public class AT_RegionPropertyDimension {
    ...
    @Test
    @UnitTestMethod(target = RegionPropertyDimension.Builder.class, name = "setRegionId", args = {
            RegionId.class })
    ...
    public void testExecuteLevel() {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            for (int level = 0; level < levelCount; level++) {
                /*
                 * Create a RegionsPluginData, filling it with the test
                ...
                for (TestRegionPropertyId propertyId : TestRegionPropertyId.values()) {
                    ...
                    pluginDataBuilder.defineRegionProperty(propertyId,
                            propertyDefinition);
                ...
                /*
                 * get the RegionsPluginData from the corresponding
                 * builder
                 */
                RegionsPluginData regionsPluginData = pluginDataBuilder.build();

                /*
                 * show that the RegionsPluginData has the value we
