...
public class AT_GlobalPropertyReportPluginData {
	...
	@Test
	@UnitTestMethod(target = GlobalPropertyReportPluginData.Builder.class, name = "setReportLabel", args = { ReportLabel.class })
	...
	@Test
	@UnitTestMethod(target = GlobalPropertyReportPluginData.Builder.class, name = "setDefaultInclusion", args = { boolean.class })
	...
	public void testGetCloneBuilder() {
		...
		for (int i = 0; i < 10; i++) {
			...
			GlobalPropertyReportPluginData cloneGlobalPropertyReportPluginData = globalPropertyReportPluginData.getCloneBuilder().build();
