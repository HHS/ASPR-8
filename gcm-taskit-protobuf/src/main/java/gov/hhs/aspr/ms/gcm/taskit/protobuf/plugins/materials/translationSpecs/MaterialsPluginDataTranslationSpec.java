...
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.BatchInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.BatchPropertyDefinitionMapInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.BatchPropertyValueInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.MaterialIdInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.MaterialsPluginDataInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.MaterialsProducerIdInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.MaterialsProducerInventoryBatchesInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.MaterialsProducerPropertyValueMapInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.MaterialsProducerResourceLevelMapInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.MaterialsProducerStagesInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.StageBatchInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.StageIdInput;
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.materials.input.StageInput;
...
import gov.hhs.aspr.ms.gcm.taskit.protobuf.plugins.resources.input.ResourceInitializationInput;
