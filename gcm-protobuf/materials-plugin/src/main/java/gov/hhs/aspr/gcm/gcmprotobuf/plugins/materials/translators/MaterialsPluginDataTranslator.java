...
import plugins.materials.input.BatchMapInput;
import plugins.materials.input.BatchPropertyDefinitionMapInput;
...
import plugins.materials.input.MaterialsProducerPropertyValueMapInput;
import plugins.materials.input.MaterialsProducerResourceLevelMapInput;
import plugins.materials.input.StageIdInput;
import plugins.materials.input.StageMapInput;
...
public class MaterialsPluginDataTranslator extends AbstractTranslator<MaterialsPluginDataInput, MaterialsPluginData> {
    ...
    protected MaterialsPluginData convertInputObject(MaterialsPluginDataInput inputObject) {
        ...
        for (BatchPropertyDefinitionMapInput batchPropertyDefinitionMapInput : inputObject
            ...
            for (PropertyDefinitionMapInput propertyDefinitionMapInput : batchPropertyDefinitionMapInput
                ...
                BatchPropertyId batchPropertyId = this.translator
                        .getObjectFromAny(propertyDefinitionMapInput.getPropertyId(), BatchPropertyId.class);
        ...
        for (PropertyDefinitionMapInput propertyDefinitionMapInput : inputObject
            ...
            MaterialsProducerPropertyId materialsProducerPropertyId = this.translator
                    .getObjectFromAny(propertyDefinitionMapInput.getPropertyId(), MaterialsProducerPropertyId.class);
            PropertyDefinition propertyDefinition = this.translator
                    .convertInputObject(propertyDefinitionMapInput.getPropertyDefinition());
        ...
        for (MaterialsProducerPropertyValueMapInput materialsProducerPropertyValueMapInput : inputObject
            ...
            MaterialsProducerId materialsProducerId = this.translator.convertInputObject(
                    materialsProducerPropertyValueMapInput.getMaterialsProducerId(), MaterialsProducerId.class);
            for (PropertyValueMapInput propertyValueMapInput : materialsProducerPropertyValueMapInput
                    .getPropertyValuesList()) {
                MaterialsProducerPropertyId materialsProducerPropertyId = this.translator.getObjectFromAny(
                        propertyValueMapInput.getPropertyId(), MaterialsProducerPropertyId.class);
        ...
        for (MaterialsProducerResourceLevelMapInput materialsProducerResourceLevelMapInput : inputObject
            ...
            MaterialsProducerId materialsProducerId = this.translator.convertInputObject(
                    materialsProducerResourceLevelMapInput.getMaterialsProducerId(), MaterialsProducerId.class);
        ...
        for (BatchMapInput batchMapInput : inputObject.getBatchIdsList()) {
            ...
            MaterialId materialId = this.translator.convertInputObject(batchMapInput.getMaterialId(), MaterialId.class);
            double amount = batchMapInput.getAmount();
            MaterialsProducerId materialsProducerId = this.translator
                    .convertInputObject(batchMapInput.getMaterialsProducerId(), MaterialsProducerId.class);
            ...
            for (PropertyValueMapInput propertyValueMapInput : batchMapInput.getPropertyValuesList()) {
                BatchPropertyId batchPropertyId = this.translator
                        .getObjectFromAny(propertyValueMapInput.getPropertyId(), BatchPropertyId.class);
        ...
        for (StageMapInput stageMapInput : inputObject.getStageIdsList()) {
            ...
            MaterialsProducerId materialsProducerId = this.translator
                    .convertInputObject(stageMapInput.getMaterialsProducerId(), MaterialsProducerId.class);
    ...
    @Override
    protected MaterialsPluginDataInput convertSimObject(MaterialsPluginData simObject) {
        ...
        for (MaterialId materialId : simObject.getMaterialIds()) {
            ...
            for (BatchPropertyId batchPropertyId : simObject.getBatchPropertyIds(materialId)) {
                ...
                PropertyDefinitionMapInput propertyDefinitionMapInput = PropertyDefinitionMapInput
                        ...
                        .setPropertyId(this.translator.getAnyFromObject(batchPropertyId, BatchPropertyId.class))
                        .build();
        ...
        for (MaterialsProducerId materialsProducerId : simObject.getMaterialsProducerIds()) {
            MaterialsProducerIdInput materialsProducerIdInput = this.translator.convertSimObject(materialsProducerId,
                    MaterialsProducerId.class);
        ...
        for (MaterialsProducerPropertyId materialsProducerPropertyId : simObject.getMaterialsProducerPropertyIds()) {
            PropertyDefinitionInput propertyDefinitionInput = this.translator
                    .convertSimObject(simObject.getMaterialsProducerPropertyDefinition(materialsProducerPropertyId));
        ...
        for (BatchId batchId : simObject.getBatchIds()) {
            ...
            MaterialIdInput materialIdInput = this.translator.convertSimObject(simObject.getBatchMaterial(batchId),
                    MaterialId.class);
            MaterialsProducerIdInput materialsProducerIdInput = this.translator
                    .convertSimObject(simObject.getBatchMaterialsProducer(batchId), MaterialsProducerId.class);
            ...
            for (BatchPropertyId propertyId : simObject.getBatchPropertyValues(batchId).keySet()) {
                ...
                batchPropertyValueMap
                        .setPropertyValue(this.translator.getAnyFromObject(value))
                        .setPropertyId(this.translator.getAnyFromObject(propertyId, BatchPropertyId.class));
        ...
        for (StageId stageId : simObject.getStageIds()) {
            ...
            MaterialsProducerIdInput materialsProducerIdInput = this.translator
                    .convertSimObject(simObject.getStageMaterialsProducer(stageId), MaterialsProducerId.class);
    ...
    public Descriptor getDescriptorForInputObject() {
        return MaterialsPluginDataInput.getDescriptor();
    }
    ...
    @Override
    public Class<MaterialsPluginData> getSimObjectClass() {
