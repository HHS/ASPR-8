...
public enum TestMaterialsProducerPropertyId implements MaterialsProducerPropertyId {
	...
	/**
	 * Returns a unique MaterialsProducerPropertyId instance that is not a member of
	 * this enumeration
	 */
	 ...
	 */
	public static TestMaterialsProducerPropertyId getRandomMaterialsProducerPropertyId(
			final RandomGenerator randomGenerator) {
		return TestMaterialsProducerPropertyId.values()[randomGenerator
				.nextInt(TestMaterialsProducerPropertyId.values().length)];
	}
	 ...
	 */
	public static TestMaterialsProducerPropertyId getRandomMutableMaterialsProducerPropertyId(
			final RandomGenerator randomGenerator) {
