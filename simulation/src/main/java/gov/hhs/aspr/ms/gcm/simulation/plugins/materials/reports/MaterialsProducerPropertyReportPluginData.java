...
/**
 * A PluginData class supporting MaterialsProducerProperty construction.
 */
@ThreadSafe
public final class MaterialsProducerPropertyReportPluginData implements PluginData {
	...
	public final static class Builder implements PluginDataBuilder {
		...
		public MaterialsProducerPropertyReportPluginData build() {
			...
			ensureImmutability();
			return new MaterialsProducerPropertyReportPluginData(data);
	...
	private MaterialsProducerPropertyReportPluginData(Data data) {
		this.data = data;
	}
	...
	/**
     * Two {@link MaterialsProducerPropertyReportPluginData} instances are equal if and only if
     * their inputs are equal.
     */
	@Override
	public boolean equals(Object obj) {
		...
		MaterialsProducerPropertyReportPluginData other = (MaterialsProducerPropertyReportPluginData) obj;
	...
	public String toString() {
		...
		builder2.append("MaterialsProducerPropertyReportPluginData [data=");
