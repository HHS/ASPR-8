...
/**
 * PeopleContainer implementor that uses hash-bucketed arrays and an array-based
 * tree to contain the people. Uses ~ 45 bits per person contained under both 4
 * byte and 8 byte pointer reference regimes.
 */
public final class IntSetPeopleContainer implements PeopleContainer {
	 ...
	 */
	public IntSetPeopleContainer(PeopleDataManager peopleDataManager) {
